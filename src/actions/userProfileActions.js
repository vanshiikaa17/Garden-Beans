...
export const updateDetails=(userData)=>async(dispatch)=>{
    try{
        ...
        const {data}=await axios.put(`${baseUrl}/api/users/changemydetails`, userData, requestHeaders);
...
export const updatePassword=(password)=>async(dispatch)=>{
    try{
        ...
        const {data}=await axios.put(`${baseUrl}/api/users/changepassword`, password, requestHeaders);
