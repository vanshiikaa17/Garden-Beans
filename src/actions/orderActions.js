...
export const getOrder = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${baseUrl}/api/orders/orderinfo/${id}`);
...
export const getAllOrders = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${baseUrl}/api/orders/admin/allorders`);
...
export const updateOrder = (id, orderData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `${baseUrl}/api/orders/admin/order/${id}`,
      orderData,
      requestHeaders
    );
...
export const deleteOrder = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`${baseUrl}/api/orders/admin/order/${id} `);
